...
We will not prove this completely, but want to explain where the polynomial growth condition comes from. This is the most surprising aspect, since we didn't build this into the definition anywhere.
